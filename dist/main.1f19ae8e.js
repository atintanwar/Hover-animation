...
var hoverMain = document.getElementById('hover-main');
var main = document.getElementById('main');
var bounds = {
  main: main.getBoundingClientRect(),
  hoverMain: hoverMain.getBoundingClientRect()
};
var mouseEnter$ = (0, _rxjs.fromEvent)(main, 'mouseenter').pipe((0, _operators.share)());
var mouseleave$ = (0, _rxjs.fromEvent)(main, 'mouseleave').pipe((0, _operators.share)());
var mousemove$ = (0, _rxjs.fromEvent)(main, 'mousemove').pipe((0, _operators.map)(function (e) {
  return {
    x: e.clientX,
    y: e.clientY
  };
}));
var animationFrame$ = (0, _rxjs.of)(0, _rxjs.animationFrameScheduler).pipe((0, _operators.repeat)());
var mouseMoveonFrame$ = animationFrame$.pipe((0, _operators.withLatestFrom)(mousemove$), (0, _operators.pluck)(1));
var updatedMoves$ = mouseEnter$.pipe((0, _operators.mergeScan)(function (acc, curr) {
  return mouseMoveonFrame$.pipe((0, _operators.startWith)(acc), (0, _operators.scan)(lerp), (0, _operators.takeUntil)(mouseleave$));
}, {
  x: 0,
  y: 0
}));
updatedMoves$.subscribe(function (_ref) {
  var x = _ref.x,
      y = _ref.y;
...
mouseEnter$.subscribe(function () {
  return hoverMain.classList.add('reveal');
});
